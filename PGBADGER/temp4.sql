    ...
    BEGIN
        ...
        FOR omega IN SELECT * FROM tmp_info_table LOOP
            BEGIN
                ...
                RAISE NOTICE 'Результат: %', Pgbadger_Report_Slicer(json_flight);
        ...
        RAISE NOTICE '%',  Pgbadger_Report_Slicer(json_flight);
...
DECLARE
    jsonb_out JSONB = '{
        "log_file": "/var/lib/postgresql/16/mbss/log/postgresql-Mon.log",
        "pgbg_path": "/usr/bin/pgbadger",
        "end_dattime": "2025-04-07 11:00:00",
        "begin_dattime": "2025-04-07 09:00:00",
        "out_dir_slice": "/home/reports/",
        "out_file_slice": "prd-chat-pg-02--5434--2025-04-07--11-04.html"
    }';
BEGIN
    RAISE NOTICE '%', robo.pgbadger_report_slicer(jsonb_out);
END $$;
---------------------------------------------------------------------------------------
